...
echo "[===============================================]>"
echo "\033[32;1m"
read -p "[root@T00Ls-b374k:~#" bro

if [ $bro = 1 ] || [ $bro = 1 ]
then
clear
figlet "B 3 7 4 K" | lolcat
cd module
php tp.php
fi
...
then
clear
toilet -f mono12 -F gay "B 3 7 4 K"
cd module
php phd.php
fi
...
then
clear
toilet -f slant -F gay "B 3 7 4 K" 
...
then
clear
toilet -f standard -F gay "B 3 7 4 K" 
...
clear
echo "\033[34;1m"
cowsay -f kiss.cow "B 3 7 4 K" | lolcat
figlet -f slant B 3 7 4 K
echo "\033[37;1m"
...
then
clear
cowsay -f sheep.cow "B 3 7 4 K" | lolcat
figlet "B 3 7 4 K" | lolcat
sleep 1
cd
cd module
...
echo "\033[32;1mauthor: B 3 7 4 K"
echo "\033[33;1mTeam: Beli brayy"
...
clear
echo "\033[31;1m"
cowsay ghostbusters.cow "B 3 7 4 K" 
figlet "B 3 7 4 K" | lolcat
apt update && apt upgrade
apt install python2
apt install python
...
then
clear
toilet -f big -F gay "B 3 7 4 K " | lolcat
sleep 1
...
if [ $bro = 0 ] || [ $bro = 00 ]
then
echo "\033[32;1mB374K CYBER TEAM"
sleep 1
